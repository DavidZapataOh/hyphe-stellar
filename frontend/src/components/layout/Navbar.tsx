    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-[1600px] items-center justify-between gap-8 px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="ml-4 flex items-center gap-1 rounded border border-yes/20 bg-yes/10 px-2 py-0.5 text-xs font-bold uppercase tracking-wider text-yes">
